  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        {/* Contenedor del formulario de SignUp */}
        <div className="bg-white py-8 px-4 shadow-xl rounded-lg sm:px-10 border border-orange-200">
          <div className="mb-6 text-center">
            ...
            <p className="text-gray-600">
              Únete a nuestra plataforma y accede a tu panel personalizado
            </p>
          </div>

          {/* Componente SignUp de Clerk con personalización */}
          <SignUp
            appearance={{
              elements: {
                rootBox: "mx-auto",
          ...
          <div className="grid gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Gestiona tus datos y preferencias desde un solo lugar
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Atención especializada para usuarios registrados
                </p>
              </div>
            </div>
          </div>
